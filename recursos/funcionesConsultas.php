...
/*     para el pdf */
    ...
    function obtenerDataGraficoFrecuenciaVSTipoOrdenPDF($dateTimeInicio,$dateTimeFin,$fechaFiltro){
        include "conexion.php";  
        $colores= array("#001BFF","#0016CE","#0012A8","#000D79","#00084D","#000531","#273EFF","#2234CE","#1928A7","#7382FF","#5761BB","#444B8E","#303562","#8700FF","#6B00CA","#54009E", "#A560FF","#874CD4","#5CA1FF","#4F8ADA","#3D6AA7","#2F4F7B","#00CAFF","#009BC4","#65DFFF","#56BBD5","#30FBCC","#29D6AE","#76F8DA","#5EC9B0","#FFF400","#CEC500","#FFF751","#DDD647","#B8B34C","#FFFA89","#DDD87A","#FFAF00","#DF9900","#C18400","#FFC139","#D5A12F","#AC8228","#FBCF6E","#D1AF65","#B29453","#FFDC90","#FF7D00","#FF9E41","#FFBD7D");
           $sql = "SELECT categorias.categoria, rs.contador as contador FROM (SELECT idCategoria, count(*) as contador FROM (SELECT * FROM ordenes WHERE terminada=1 AND ".$fechaFiltro." BETWEEN '".$dateTimeInicio."' AND '".$dateTimeFin."') as w GROUP BY w.idCategoria) rs, categorias WHERE rs.idCategoria=categorias.id";
           $result = mysqli_query($conn, $sql);
           $labels_frecuenciaCategorias =[];
           $cantidades_frecuenciaCategorias= [];
           $colores_frecuenciaCategorias= [];
    ...
    function obtenerDataGraficoCostoMaterialesVSTipoTrabajoPDF($dateTimeInicio,$dateTimeFin,$fechaFiltro){
        include "conexion.php";  
        $colores= array("#001BFF","#0016CE","#0012A8","#000D79","#00084D","#000531","#273EFF","#2234CE","#1928A7","#7382FF","#5761BB","#444B8E","#303562","#8700FF","#6B00CA","#54009E", "#A560FF","#874CD4","#5CA1FF","#4F8ADA","#3D6AA7","#2F4F7B","#00CAFF","#009BC4","#65DFFF","#56BBD5","#30FBCC","#29D6AE","#76F8DA","#5EC9B0","#FFF400","#CEC500","#FFF751","#DDD647","#B8B34C","#FFFA89","#DDD87A","#FFAF00","#DF9900","#C18400","#FFC139","#D5A12F","#AC8228","#FBCF6E","#D1AF65","#B29453","#FFDC90","#FF7D00","#FF9E41","#FFBD7D");
        $sql = "SELECT categorias.categoria, rs.precioMateriales as precioMateriales FROM (SELECT idCategoria, sum(precioMateriales) as precioMateriales FROM (SELECT * FROM ordenes WHERE terminada=1 AND ".$fechaFiltro." BETWEEN '".$dateTimeInicio."' AND '".$dateTimeFin."') as w GROUP BY w.idCategoria) rs, categorias WHERE rs.idCategoria=categorias.id";
        $result = mysqli_query($conn, $sql);
        $labels_costoMaterialesCategorias =[];
        $cantidades_costoMaterialesCategorias= [];
        $colores_costoMaterialesCategorias= [];
    ...
    function obtenerDataGraficoCostoFuncionariosEjecutivosVSTipoTrabajoPDF($dateTimeInicio,$dateTimeFin,$fechaFiltro){
        include "conexion.php";  
        $colores= array("#001BFF","#0016CE","#0012A8","#000D79","#00084D","#000531","#273EFF","#2234CE","#1928A7","#7382FF","#5761BB","#444B8E","#303562","#8700FF","#6B00CA","#54009E", "#A560FF","#874CD4","#5CA1FF","#4F8ADA","#3D6AA7","#2F4F7B","#00CAFF","#009BC4","#65DFFF","#56BBD5","#30FBCC","#29D6AE","#76F8DA","#5EC9B0","#FFF400","#CEC500","#FFF751","#DDD647","#B8B34C","#FFFA89","#DDD87A","#FFAF00","#DF9900","#C18400","#FFC139","#D5A12F","#AC8228","#FBCF6E","#D1AF65","#B29453","#FFDC90","#FF7D00","#FF9E41","#FFBD7D");
        $sql = "SELECT categorias.categoria, precioFuncionariosEjecutores FROM (SELECT idCategoria, sum(precioFuncionariosEjecutores*horasHombre) as precioFuncionariosEjecutores FROM (SELECT * FROM ordenes WHERE terminada=1 AND ".$fechaFiltro." BETWEEN '".$dateTimeInicio."' AND '".$dateTimeFin."') as w GROUP BY w.idCategoria) rs, categorias WHERE rs.idCategoria=categorias.id";
        $result = mysqli_query($conn, $sql);
        $labels_costoFuncionariosEjecutivosCategorias =[];
        $cantidades_costoFuncionariosEjecutivosCategorias= [];
        $colores_costoFuncionariosEjecutivosCategorias= [];
    ...
    function obtenerDataGraficoCostoTotalVSTipoTrabajoPDF($dateTimeInicio,$dateTimeFin,$fechaFiltro){
        include "conexion.php";  
        $colores= array("#001BFF","#0016CE","#0012A8","#000D79","#00084D","#000531","#273EFF","#2234CE","#1928A7","#7382FF","#5761BB","#444B8E","#303562","#8700FF","#6B00CA","#54009E", "#A560FF","#874CD4","#5CA1FF","#4F8ADA","#3D6AA7","#2F4F7B","#00CAFF","#009BC4","#65DFFF","#56BBD5","#30FBCC","#29D6AE","#76F8DA","#5EC9B0","#FFF400","#CEC500","#FFF751","#DDD647","#B8B34C","#FFFA89","#DDD87A","#FFAF00","#DF9900","#C18400","#FFC139","#D5A12F","#AC8228","#FBCF6E","#D1AF65","#B29453","#FFDC90","#FF7D00","#FF9E41","#FFBD7D");
        $sql = "SELECT categorias.categoria, costosTotal FROM (SELECT idCategoria, sum(costoTotal) as costosTotal FROM (SELECT * FROM ordenes WHERE terminada=1 AND ".$fechaFiltro." BETWEEN '".$dateTimeInicio."' AND '".$dateTimeFin."') as w GROUP BY w.idCategoria) rs, categorias WHERE rs.idCategoria=categorias.id";
        $result = mysqli_query($conn, $sql);
        $labels_costoTotalCategorias =[];
        $cantidades_costoTotalCategorias= [];
        $colores_costoTotalCategorias= [];
    ...
    function obtenerDataGraficoFrecuenciaVSOrdenesPorHorasPDF($dateTimeInicio,$dateTimeFin,$fechaFiltro){
        include "conexion.php";  
        $colores= array("#001BFF","#0016CE","#0012A8","#000D79","#00084D","#000531","#273EFF","#2234CE","#1928A7","#7382FF","#5761BB","#444B8E","#303562","#8700FF","#6B00CA","#54009E", "#A560FF","#874CD4","#5CA1FF","#4F8ADA","#3D6AA7","#2F4F7B","#00CAFF","#009BC4","#65DFFF","#56BBD5","#30FBCC","#29D6AE","#76F8DA","#5EC9B0","#FFF400","#CEC500","#FFF751","#DDD647","#B8B34C","#FFFA89","#DDD87A","#FFAF00","#DF9900","#C18400","#FFC139","#D5A12F","#AC8228","#FBCF6E","#D1AF65","#B29453","#FFDC90","#FF7D00","#FF9E41","#FFBD7D");
        $sql = "SELECT horasHombre, count(*) as frecuenciaHoras FROM (SELECT * FROM ordenes WHERE terminada=1 AND ".$fechaFiltro." BETWEEN '".$dateTimeInicio."' AND '".$dateTimeFin."') as w GROUP BY w.horasHombre";
        $result = mysqli_query($conn, $sql);
        $labels_frecuenciaOrdenesPorHoras =[];
        $cantidades_frecuenciaOrdenesPorHoras= [];
        $colores_frecuenciaOrdenesPorHoras= [];
