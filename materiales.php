  ...
  <div id="container">
    ...
    <div id="container-nav">
      ...
      <a href="./materiales.php" class="option-nav">
        <div id="container-option"> <i class="fa-solid fa-screwdriver-wrench" style="color:#374da5"></i> Materiales </div>  
      </a>  
          ...
          <table id="tablaO" class="table" cellspacing="0">
            <thead>
              <tr>
                ...
                <th class="th-sm">PrecioUnitario</th>
              ...
              <?php
                ...
                if (mysqli_num_rows($result) > 0) {
                  while($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td id='".$row["id"]."' class='tdOrdenes'>" . $row["precioUnitario"]. "</td>";
                    echo "<td id='".$row["id"]."' class='tdOrdenes'> <a href='./recursos/eliminarMaterial.php?id=".$row["id"]."'><button type='button' class='btn btn-danger'>Eliminar</button></a></td>";                                
                    echo "</tr>";
                  }
                } else {
                    echo "0 resultados";
